...
* No commented out code (it's in source control!)

## Things to Keep in Mind
* Write for maintainability (if there's a better way take the time to do it)
* Unit (controller and model) tests are implicit in the story.  Write them.
* If you write a view, schedule time to write an acceptance test.
* Bug fixes should be submitted with an accompanying regression test
